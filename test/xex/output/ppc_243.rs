...
pub fn sub_832B85E0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B85E0 size=20
    let mut pc: u32 = 0x832B85E0;
    'dispatch: loop {
        match pc {
            0x832B85E0 => {
    //   block [0x832B85E0..0x832B85F4)
	// 832B85E0: 3D608204  lis r11, -0x7dfc
	ctx.r[11].s64 = -2113667072;
	// 832B85E4: 3D408334  lis r10, -0x7ccc
	ctx.r[10].s64 = -2093744128;
	// 832B85E8: 396BB254  addi r11, r11, -0x4dac
	ctx.r[11].s64 = ctx.r[11].s64 + -19884;
	// 832B85EC: 916A54E0  stw r11, 0x54e0(r10)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[10].u32.wrapping_add(21728 as u32), ctx.r[11].u32 ) };
	// 832B85F0: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B85F8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B85F8 size=20
    let mut pc: u32 = 0x832B85F8;
    'dispatch: loop {
        match pc {
            0x832B85F8 => {
    //   block [0x832B85F8..0x832B860C)
	// 832B85F8: 3D60820F  lis r11, -0x7df1
	ctx.r[11].s64 = -2112946176;
	// 832B85FC: 3D408334  lis r10, -0x7ccc
	ctx.r[10].s64 = -2093744128;
	// 832B8600: 396B2390  addi r11, r11, 0x2390
	ctx.r[11].s64 = ctx.r[11].s64 + 9104;
	// 832B8604: 916A581C  stw r11, 0x581c(r10)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[10].u32.wrapping_add(22556 as u32), ctx.r[11].u32 ) };
	// 832B8608: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B8610(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B8610 size=20
    let mut pc: u32 = 0x832B8610;
    'dispatch: loop {
        match pc {
            0x832B8610 => {
    //   block [0x832B8610..0x832B8624)
	// 832B8610: 3D608334  lis r11, -0x7ccc
	ctx.r[11].s64 = -2093744128;
	// 832B8614: 39400000  li r10, 0
	ctx.r[10].s64 = 0;
	// 832B8618: 396B4EB0  addi r11, r11, 0x4eb0
	ctx.r[11].s64 = ctx.r[11].s64 + 20144;
	// 832B861C: 914B0400  stw r10, 0x400(r11)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[11].u32.wrapping_add(1024 as u32), ctx.r[10].u32 ) };
	// 832B8620: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B8628(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B8628 size=20
    let mut pc: u32 = 0x832B8628;
    'dispatch: loop {
        match pc {
            0x832B8628 => {
    //   block [0x832B8628..0x832B863C)
	// 832B8628: 3D60820F  lis r11, -0x7df1
	ctx.r[11].s64 = -2112946176;
	// 832B862C: 3D408334  lis r10, -0x7ccc
	ctx.r[10].s64 = -2093744128;
	// 832B8630: 396B2390  addi r11, r11, 0x2390
	ctx.r[11].s64 = ctx.r[11].s64 + 9104;
	// 832B8634: 916A5C6C  stw r11, 0x5c6c(r10)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[10].u32.wrapping_add(23660 as u32), ctx.r[11].u32 ) };
	// 832B8638: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B8640(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B8640 size=20
    let mut pc: u32 = 0x832B8640;
    'dispatch: loop {
        match pc {
            0x832B8640 => {
    //   block [0x832B8640..0x832B8654)
	// 832B8640: 3D60820F  lis r11, -0x7df1
	ctx.r[11].s64 = -2112946176;
	// 832B8644: 3D408334  lis r10, -0x7ccc
	ctx.r[10].s64 = -2093744128;
	// 832B8648: 396B2390  addi r11, r11, 0x2390
	ctx.r[11].s64 = ctx.r[11].s64 + 9104;
	// 832B864C: 916A5D84  stw r11, 0x5d84(r10)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[10].u32.wrapping_add(23940 as u32), ctx.r[11].u32 ) };
	// 832B8650: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B8658(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B8658 size=20
    let mut pc: u32 = 0x832B8658;
    'dispatch: loop {
        match pc {
            0x832B8658 => {
    //   block [0x832B8658..0x832B866C)
	// 832B8658: 3D60820F  lis r11, -0x7df1
	ctx.r[11].s64 = -2112946176;
	// 832B865C: 3D408334  lis r10, -0x7ccc
	ctx.r[10].s64 = -2093744128;
	// 832B8660: 396B2390  addi r11, r11, 0x2390
	ctx.r[11].s64 = ctx.r[11].s64 + 9104;
	// 832B8664: 916A5E98  stw r11, 0x5e98(r10)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[10].u32.wrapping_add(24216 as u32), ctx.r[11].u32 ) };
	// 832B8668: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B8670(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B8670 size=20
    let mut pc: u32 = 0x832B8670;
    'dispatch: loop {
        match pc {
            0x832B8670 => {
    //   block [0x832B8670..0x832B8684)
	// 832B8670: 3D608204  lis r11, -0x7dfc
	ctx.r[11].s64 = -2113667072;
	// 832B8674: 3D408334  lis r10, -0x7ccc
	ctx.r[10].s64 = -2093744128;
	// 832B8678: 396BB254  addi r11, r11, -0x4dac
	ctx.r[11].s64 = ctx.r[11].s64 + -19884;
	// 832B867C: 916A60C0  stw r11, 0x60c0(r10)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[10].u32.wrapping_add(24768 as u32), ctx.r[11].u32 ) };
	// 832B8680: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B8688(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B8688 size=20
    let mut pc: u32 = 0x832B8688;
    'dispatch: loop {
        match pc {
            0x832B8688 => {
    //   block [0x832B8688..0x832B869C)
	// 832B8688: 3D608204  lis r11, -0x7dfc
	ctx.r[11].s64 = -2113667072;
	// 832B868C: 3D408334  lis r10, -0x7ccc
	ctx.r[10].s64 = -2093744128;
	// 832B8690: 396BB254  addi r11, r11, -0x4dac
	ctx.r[11].s64 = ctx.r[11].s64 + -19884;
	// 832B8694: 916A5FAC  stw r11, 0x5fac(r10)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[10].u32.wrapping_add(24492 as u32), ctx.r[11].u32 ) };
	// 832B8698: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B86A0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B86A0 size=20
    let mut pc: u32 = 0x832B86A0;
    'dispatch: loop {
        match pc {
            0x832B86A0 => {
    //   block [0x832B86A0..0x832B86B4)
	// 832B86A0: 3D608204  lis r11, -0x7dfc
	ctx.r[11].s64 = -2113667072;
	// 832B86A4: 3D408334  lis r10, -0x7ccc
	ctx.r[10].s64 = -2093744128;
	// 832B86A8: 396BB254  addi r11, r11, -0x4dac
	ctx.r[11].s64 = ctx.r[11].s64 + -19884;
	// 832B86AC: 916A61D4  stw r11, 0x61d4(r10)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[10].u32.wrapping_add(25044 as u32), ctx.r[11].u32 ) };
	// 832B86B0: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B86B8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B86B8 size=20
    let mut pc: u32 = 0x832B86B8;
    'dispatch: loop {
        match pc {
            0x832B86B8 => {
    //   block [0x832B86B8..0x832B86CC)
	// 832B86B8: 3D608204  lis r11, -0x7dfc
	ctx.r[11].s64 = -2113667072;
	// 832B86BC: 3D408334  lis r10, -0x7ccc
	ctx.r[10].s64 = -2093744128;
	// 832B86C0: 396BB254  addi r11, r11, -0x4dac
	ctx.r[11].s64 = ctx.r[11].s64 + -19884;
	// 832B86C4: 916A62EC  stw r11, 0x62ec(r10)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[10].u32.wrapping_add(25324 as u32), ctx.r[11].u32 ) };
	// 832B86C8: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B86D0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B86D0 size=20
    let mut pc: u32 = 0x832B86D0;
    'dispatch: loop {
        match pc {
            0x832B86D0 => {
    //   block [0x832B86D0..0x832B86E4)
	// 832B86D0: 3D608204  lis r11, -0x7dfc
	ctx.r[11].s64 = -2113667072;
	// 832B86D4: 3D408334  lis r10, -0x7ccc
	ctx.r[10].s64 = -2093744128;
	// 832B86D8: 396BB254  addi r11, r11, -0x4dac
	ctx.r[11].s64 = ctx.r[11].s64 + -19884;
	// 832B86DC: 916A6404  stw r11, 0x6404(r10)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[10].u32.wrapping_add(25604 as u32), ctx.r[11].u32 ) };
	// 832B86E0: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B86E8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B86E8 size=20
    let mut pc: u32 = 0x832B86E8;
    'dispatch: loop {
        match pc {
            0x832B86E8 => {
    //   block [0x832B86E8..0x832B86FC)
	// 832B86E8: 3D608204  lis r11, -0x7dfc
	ctx.r[11].s64 = -2113667072;
	// 832B86EC: 3D408334  lis r10, -0x7ccc
	ctx.r[10].s64 = -2093744128;
	// 832B86F0: 396BB254  addi r11, r11, -0x4dac
	ctx.r[11].s64 = ctx.r[11].s64 + -19884;
	// 832B86F4: 916A6920  stw r11, 0x6920(r10)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[10].u32.wrapping_add(26912 as u32), ctx.r[11].u32 ) };
	// 832B86F8: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B8700(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B8700 size=20
    let mut pc: u32 = 0x832B8700;
    'dispatch: loop {
        match pc {
            0x832B8700 => {
    //   block [0x832B8700..0x832B8714)
	// 832B8700: 3D608334  lis r11, -0x7ccc
	ctx.r[11].s64 = -2093744128;
	// 832B8704: 39400000  li r10, 0
	ctx.r[10].s64 = 0;
	// 832B8708: 396B6518  addi r11, r11, 0x6518
	ctx.r[11].s64 = ctx.r[11].s64 + 25880;
	// 832B870C: 914B0400  stw r10, 0x400(r11)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[11].u32.wrapping_add(1024 as u32), ctx.r[10].u32 ) };
	// 832B8710: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B8880(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
	...
	crate::recompiler::externs::call(ctx, base, 0x82E84C68);
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_832B90C0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B90C0 size=24
    let mut pc: u32 = 0x832B90C0;
    'dispatch: loop {
        match pc {
            0x832B90C0 => {
    //   block [0x832B90C0..0x832B90D8)
...
pub fn sub_832B90D8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B90D8 size=4
    let mut pc: u32 = 0x832B90D8;
    'dispatch: loop {
        match pc {
            0x832B90D8 => {
    //   block [0x832B90D8..0x832B90DC)
...
pub fn sub_832B90E0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B90E0 size=24
    let mut pc: u32 = 0x832B90E0;
    'dispatch: loop {
        match pc {
            0x832B90E0 => {
    //   block [0x832B90E0..0x832B90F8)
...
pub fn sub_832B90F8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x832B90F8 size=4
    let mut pc: u32 = 0x832B90F8;
    'dispatch: loop {
        match pc {
            0x832B90F8 => {
    //   block [0x832B90F8..0x832B90FC)
...
pub fn sub_832B9360(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
	...
	crate::recompiler::externs::call(ctx, base, 0x83002D18);
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
