...
pub fn sub_82DF5EA0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
	...
	ctx.r[8].s32 = ((ctx.r[7].s32 as i64 * ctx.r[8].s32 as i64) as i32);
	ctx.r[8].s64 = ctx.r[8].s32 as i64;
	...
	ctx.r[3].s32 = ((ctx.r[7].s32 as i64 * 304 as i64) as i32);
	ctx.r[3].s64 = ctx.r[3].s32 as i64;
	...
	ctx.r[4].s32 = ((ctx.r[4].s32 as i64 * 1268 as i64) as i32);
	...
	ctx.r[7].s32 = ((ctx.r[7].s32 as i64 * 1264 as i64) as i32);
	ctx.r[7].s64 = ctx.r[7].s32 as i64;
...
pub fn sub_82DF70F8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
	...
	pc = 0x82DF73D4; continue 'dispatch;
            ...
            0x82DF73D4 => {
    //   block [0x82DF73D4..0x82DF73EC)
	// 82DF73D4: 382100B0  addi r1, r1, 0xb0
	ctx.r[1].s64 = ctx.r[1].s64 + 176;
	// 82DF73D8: 8181FFF8  lwz r12, -8(r1)
	ctx.r[12].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[1].u32.wrapping_add(-8 as u32) ) } as u64;
	// 82DF73DC: 7D8803A6  mtlr r12
	ctx.lr = ctx.r[12].u64;
	// 82DF73E0: EBC1FFE8  ld r30, -0x18(r1)
	ctx.r[30].u64 = unsafe { crate::rt::load_u64( base as *const u8, ctx.r[1].u32.wrapping_add(-24 as u32) ) };
	// 82DF73E4: EBE1FFF0  ld r31, -0x10(r1)
	ctx.r[31].u64 = unsafe { crate::rt::load_u64( base as *const u8, ctx.r[1].u32.wrapping_add(-16 as u32) ) };
	// 82DF73E8: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
