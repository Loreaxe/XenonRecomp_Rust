...
pub fn sub_82D634A0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82D634A0 size=32
    let mut pc: u32 = 0x82D634A0;
    'dispatch: loop {
        match pc {
            0x82D634A0 => {
    //   block [0x82D634A0..0x82D634C0)
