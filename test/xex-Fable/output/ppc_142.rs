...
pub fn sub_82D85758(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
	...
	if !ctx.cr[6].lt {
		crate::recompiler::externs::call(ctx, base, 0x82D8577C);
		return;
	}
...
pub fn sub_82D85CE8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
	...
	pc = 0x82D85D78; continue 'dispatch;
            ...
            0x82D85D74 => {
    //   block [0x82D85D74..0x82D85D78)
	// 82D85D74: 7FEBFB78  mr r11, r31
	ctx.r[11].u64 = ctx.r[31].u64;
	pc = 0x82D85D78; continue 'dispatch;
            }
            0x82D85D78 => {
    //   block [0x82D85D78..0x82D85D7C)
...
pub fn sub_82D85E18(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
	...
	pc = 0x82D85EA8; continue 'dispatch;
            ...
            0x82D85EA4 => {
    //   block [0x82D85EA4..0x82D85EA8)
	// 82D85EA4: 7FCBF378  mr r11, r30
	ctx.r[11].u64 = ctx.r[30].u64;
	pc = 0x82D85EA8; continue 'dispatch;
            }
            0x82D85EA8 => {
    //   block [0x82D85EA8..0x82D85EAC)
	// 82D85EA8: 917F00CC  stw r11, 0xcc(r31)
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[31].u32.wrapping_add(204 as u32), ctx.r[11].u32 ) };
	pc = 0x82D85EAC; continue 'dispatch;
            }
            0x82D85EAC => {
    //   block [0x82D85EAC..0x82D85EC4)
	...
	pc = 0x82D85EE0; continue 'dispatch;
            ...
            0x82D85EE0 => {
    //   block [0x82D85EE0..0x82D85EE4)
	// 82D85EE0: 3960FFFF  li r11, -1
	ctx.r[11].s64 = -1;
	pc = 0x82D85EE4; continue 'dispatch;
            }
            0x82D85EE4 => {
    //   block [0x82D85EE4..0x82D85EF8)
