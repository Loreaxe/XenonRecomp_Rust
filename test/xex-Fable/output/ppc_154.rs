...
pub fn sub_82E51550(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82E51550 size=32
    let mut pc: u32 = 0x82E51550;
    'dispatch: loop {
        match pc {
            0x82E51550 => {
    //   block [0x82E51550..0x82E51570)
...
pub fn sub_82E51578(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82E51578 size=16
    let mut pc: u32 = 0x82E51578;
    'dispatch: loop {
        match pc {
            0x82E51578 => {
    //   block [0x82E51578..0x82E51588)
...
pub fn sub_82E51588(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82E51588 size=4
    let mut pc: u32 = 0x82E51588;
    'dispatch: loop {
        match pc {
            0x82E51588 => {
    //   block [0x82E51588..0x82E5158C)
...
pub fn sub_82E51590(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82E51590 size=32
    let mut pc: u32 = 0x82E51590;
    'dispatch: loop {
        match pc {
            0x82E51590 => {
    //   block [0x82E51590..0x82E515B0)
