...
pub fn sub_8248F718(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248F718 size=12
    let mut pc: u32 = 0x8248F718;
    'dispatch: loop {
        match pc {
            0x8248F718 => {
    //   block [0x8248F718..0x8248F724)
...
pub fn sub_8248F724(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248F724 size=8
    let mut pc: u32 = 0x8248F724;
    'dispatch: loop {
        match pc {
            0x8248F724 => {
    //   block [0x8248F724..0x8248F72C)
...
pub fn sub_8248F810(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248F810 size=8
    let mut pc: u32 = 0x8248F810;
    'dispatch: loop {
        match pc {
            0x8248F810 => {
    //   block [0x8248F810..0x8248F818)
...
pub fn sub_8248F818(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248F818 size=8
    let mut pc: u32 = 0x8248F818;
    'dispatch: loop {
        match pc {
            0x8248F818 => {
    //   block [0x8248F818..0x8248F820)
...
pub fn sub_8248F828(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248F828 size=8
    let mut pc: u32 = 0x8248F828;
    'dispatch: loop {
        match pc {
            0x8248F828 => {
    //   block [0x8248F828..0x8248F830)
...
pub fn sub_8248F830(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248F830 size=8
    let mut pc: u32 = 0x8248F830;
    'dispatch: loop {
        match pc {
            0x8248F830 => {
    //   block [0x8248F830..0x8248F838)
...
pub fn sub_8248F938(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248F938 size=8
    let mut pc: u32 = 0x8248F938;
    'dispatch: loop {
        match pc {
            0x8248F938 => {
    //   block [0x8248F938..0x8248F940)
...
pub fn sub_8248F940(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248F940 size=24
    let mut pc: u32 = 0x8248F940;
    'dispatch: loop {
        match pc {
            0x8248F940 => {
    //   block [0x8248F940..0x8248F958)
...
pub fn sub_8248F980(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248F980 size=8
    let mut pc: u32 = 0x8248F980;
    'dispatch: loop {
        match pc {
            0x8248F980 => {
    //   block [0x8248F980..0x8248F988)
...
pub fn sub_8248F988(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248F988 size=24
    let mut pc: u32 = 0x8248F988;
    'dispatch: loop {
        match pc {
            0x8248F988 => {
    //   block [0x8248F988..0x8248F9A0)
...
pub fn sub_8248FA10(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248FA10 size=8
    let mut pc: u32 = 0x8248FA10;
    'dispatch: loop {
        match pc {
            0x8248FA10 => {
    //   block [0x8248FA10..0x8248FA18)
...
pub fn sub_8248FA18(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248FA18 size=24
    let mut pc: u32 = 0x8248FA18;
    'dispatch: loop {
        match pc {
            0x8248FA18 => {
    //   block [0x8248FA18..0x8248FA30)
...
pub fn sub_8248FADC(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248FADC size=24
    let mut pc: u32 = 0x8248FADC;
    'dispatch: loop {
        match pc {
            0x8248FADC => {
    //   block [0x8248FADC..0x8248FAF4)
...
pub fn sub_8248FAF4(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248FAF4 size=40
    let mut pc: u32 = 0x8248FAF4;
    'dispatch: loop {
        match pc {
            0x8248FAF4 => {
    //   block [0x8248FAF4..0x8248FB1C)
...
pub fn sub_8248FBA0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248FBA0 size=16
    let mut pc: u32 = 0x8248FBA0;
    'dispatch: loop {
        match pc {
            0x8248FBA0 => {
    //   block [0x8248FBA0..0x8248FBB0)
...
pub fn sub_8248FBB0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248FBB0 size=44
    let mut pc: u32 = 0x8248FBB0;
    'dispatch: loop {
        match pc {
            0x8248FBB0 => {
    //   block [0x8248FBB0..0x8248FBDC)
...
pub fn sub_8248FC48(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248FC48 size=24
    let mut pc: u32 = 0x8248FC48;
    'dispatch: loop {
        match pc {
            0x8248FC48 => {
    //   block [0x8248FC48..0x8248FC60)
	// 8248FC48: 7C6B1B78  mr r11, r3
	ctx.r[11].u64 = ctx.r[3].u64;
	// 8248FC4C: 386B00D0  addi r3, r11, 0xd0
	ctx.r[3].s64 = ctx.r[11].s64 + 208;
	// 8248FC50: 816B00D0  lwz r11, 0xd0(r11)
	ctx.r[11].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[11].u32.wrapping_add(208 as u32) ) } as u64;
	// 8248FC54: 816B0010  lwz r11, 0x10(r11)
	ctx.r[11].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[11].u32.wrapping_add(16 as u32) ) } as u64;
	// 8248FC58: 7D6903A6  mtctr r11
	ctx.ctr.u64 = ctx.r[11].u64;
	// 8248FC5C: 4E800420  bctr
	crate::rt::call_indirect(ctx.ctr.u32);
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
...
pub fn sub_8248FC60(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    let mut tmp: PPCRegister = Default::default();
    // ---- function 0x8248FC60 size=8
    let mut pc: u32 = 0x8248FC60;
    'dispatch: loop {
        match pc {
            0x8248FC60 => {
    //   block [0x8248FC60..0x8248FC68)
	// 8248FC60: D0230084  stfs f1, 0x84(r3)
	ctx.fpscr.disable_flush_mode_unconditional();
	tmp.f32 = (ctx.f[1].f64 as f32);
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[3].u32.wrapping_add(132 as u32), tmp.u32 ) };
	// 8248FC64: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_8248FC68(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    let mut tmp: PPCRegister = Default::default();
    // ---- function 0x8248FC68 size=8
    let mut pc: u32 = 0x8248FC68;
    'dispatch: loop {
        match pc {
            0x8248FC68 => {
    //   block [0x8248FC68..0x8248FC70)
	// 8248FC68: D0230088  stfs f1, 0x88(r3)
	ctx.fpscr.disable_flush_mode_unconditional();
	tmp.f32 = (ctx.f[1].f64 as f32);
	unsafe { crate::rt::store_u32( base as *mut u8, ctx.r[3].u32.wrapping_add(136 as u32), tmp.u32 ) };
	// 8248FC6C: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_8248FC88(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8248FC88 size=24
    let mut pc: u32 = 0x8248FC88;
    'dispatch: loop {
        match pc {
            0x8248FC88 => {
    //   block [0x8248FC88..0x8248FCA0)
	// 8248FC88: 7C6B1B78  mr r11, r3
	ctx.r[11].u64 = ctx.r[3].u64;
	// 8248FC8C: 386B00D0  addi r3, r11, 0xd0
	ctx.r[3].s64 = ctx.r[11].s64 + 208;
	// 8248FC90: 816B00D0  lwz r11, 0xd0(r11)
	ctx.r[11].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[11].u32.wrapping_add(208 as u32) ) } as u64;
	// 8248FC94: 816B0020  lwz r11, 0x20(r11)
	ctx.r[11].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[11].u32.wrapping_add(32 as u32) ) } as u64;
	// 8248FC98: 7D6903A6  mtctr r11
	ctx.ctr.u64 = ctx.r[11].u64;
	// 8248FC9C: 4E800420  bctr
	crate::rt::call_indirect(ctx.ctr.u32);
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
...
pub fn sub_8249059C(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8249059C size=8
    let mut pc: u32 = 0x8249059C;
    'dispatch: loop {
        match pc {
            0x8249059C => {
    //   block [0x8249059C..0x824905A4)
	// 8249059C: 806301E8  lwz r3, 0x1e8(r3)
	ctx.r[3].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[3].u32.wrapping_add(488 as u32) ) } as u64;
	// 824905A0: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_824905A8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824905A8 size=28
    let mut pc: u32 = 0x824905A8;
    'dispatch: loop {
        match pc {
            0x824905A8 => {
    //   block [0x824905A8..0x824905C4)
	// 824905A8: 896300D8  lbz r11, 0xd8(r3)
	ctx.r[11].u64 = unsafe { crate::rt::load_u8( base as *const u8, ctx.r[3].u32.wrapping_add(216 as u32) ) } as u64;
	// 824905AC: 2B0B0006  cmplwi cr6, r11, 6
	ctx.cr[6].compare_u32(ctx.r[11].u32, 6 as u32, &mut ctx.xer);
	// 824905B0: 419A0014  beq cr6, 0x824905c4
	if ctx.cr[6].eq {
		sub_824905C4(ctx, base);
		return;
	}
	// 824905B4: 2B0B0007  cmplwi cr6, r11, 7
	ctx.cr[6].compare_u32(ctx.r[11].u32, 7 as u32, &mut ctx.xer);
	// 824905B8: 419A000C  beq cr6, 0x824905c4
	if ctx.cr[6].eq {
		sub_824905C4(ctx, base);
		return;
	}
	// 824905BC: 38600000  li r3, 0
	ctx.r[3].s64 = 0;
	// 824905C0: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_824905C4(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824905C4 size=8
    let mut pc: u32 = 0x824905C4;
    'dispatch: loop {
        match pc {
            0x824905C4 => {
    //   block [0x824905C4..0x824905CC)
	// 824905C4: 806301E8  lwz r3, 0x1e8(r3)
	ctx.r[3].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[3].u32.wrapping_add(488 as u32) ) } as u64;
	// 824905C8: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_824910D8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824910D8 size=12
    let mut pc: u32 = 0x824910D8;
    'dispatch: loop {
        match pc {
            0x824910D8 => {
    //   block [0x824910D8..0x824910E4)
	// 824910D8: 38800001  li r4, 1
	ctx.r[4].s64 = 1;
	// 824910DC: 2B030000  cmplwi cr6, r3, 0
	ctx.cr[6].compare_u32(ctx.r[3].u32, 0 as u32, &mut ctx.xer);
	// 824910E0: 4D9A0020  beqlr cr6
	if ctx.cr[6].eq { return; }
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_824910E4(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824910E4 size=8
    let mut pc: u32 = 0x824910E4;
    'dispatch: loop {
        match pc {
            0x824910E4 => {
    //   block [0x824910E4..0x824910EC)
	// 824910E4: 48005FE4  b 0x824970c8
	sub_824970C8(ctx, base);
	return;
	// 824910E8: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_824910F0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824910F0 size=20
    let mut pc: u32 = 0x824910F0;
    'dispatch: loop {
        match pc {
            0x824910F0 => {
    //   block [0x824910F0..0x82491104)
	// 824910F0: 81630000  lwz r11, 0(r3)
	ctx.r[11].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[3].u32.wrapping_add(0 as u32) ) } as u64;
	// 824910F4: 38800000  li r4, 0
	ctx.r[4].s64 = 0;
	// 824910F8: 816B0000  lwz r11, 0(r11)
	ctx.r[11].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[11].u32.wrapping_add(0 as u32) ) } as u64;
	// 824910FC: 7D6903A6  mtctr r11
	ctx.ctr.u64 = ctx.r[11].u64;
	// 82491100: 4E800420  bctr
	crate::rt::call_indirect(ctx.ctr.u32);
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
...
pub fn sub_82491160(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491160 size=8
    let mut pc: u32 = 0x82491160;
    'dispatch: loop {
        match pc {
            0x82491160 => {
    //   block [0x82491160..0x82491168)
...
pub fn sub_82491168(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491168 size=24
    let mut pc: u32 = 0x82491168;
    'dispatch: loop {
        match pc {
            0x82491168 => {
    //   block [0x82491168..0x82491180)
...
pub fn sub_824911B8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824911B8 size=8
    let mut pc: u32 = 0x824911B8;
    'dispatch: loop {
        match pc {
            0x824911B8 => {
    //   block [0x824911B8..0x824911C0)
...
pub fn sub_824911C0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824911C0 size=24
    let mut pc: u32 = 0x824911C0;
    'dispatch: loop {
        match pc {
            0x824911C0 => {
    //   block [0x824911C0..0x824911D8)
...
pub fn sub_82491210(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491210 size=12
    let mut pc: u32 = 0x82491210;
    'dispatch: loop {
        match pc {
            0x82491210 => {
    //   block [0x82491210..0x8249121C)
...
pub fn sub_8249121C(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8249121C size=8
    let mut pc: u32 = 0x8249121C;
    'dispatch: loop {
        match pc {
            0x8249121C => {
    //   block [0x8249121C..0x82491224)
...
pub fn sub_824912D8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824912D8 size=8
    let mut pc: u32 = 0x824912D8;
    'dispatch: loop {
        match pc {
            0x824912D8 => {
    //   block [0x824912D8..0x824912E0)
...
pub fn sub_824912E0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824912E0 size=24
    let mut pc: u32 = 0x824912E0;
    'dispatch: loop {
        match pc {
            0x824912E0 => {
    //   block [0x824912E0..0x824912F8)
...
pub fn sub_82491320(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491320 size=8
    let mut pc: u32 = 0x82491320;
    'dispatch: loop {
        match pc {
            0x82491320 => {
    //   block [0x82491320..0x82491328)
...
pub fn sub_82491328(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491328 size=24
    let mut pc: u32 = 0x82491328;
    'dispatch: loop {
        match pc {
            0x82491328 => {
    //   block [0x82491328..0x82491340)
...
pub fn sub_824913D0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824913D0 size=12
    let mut pc: u32 = 0x824913D0;
    'dispatch: loop {
        match pc {
            0x824913D0 => {
    //   block [0x824913D0..0x824913DC)
...
pub fn sub_824913DC(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824913DC size=32
    let mut pc: u32 = 0x824913DC;
    'dispatch: loop {
        match pc {
            0x824913DC => {
    //   block [0x824913DC..0x824913FC)
...
pub fn sub_824914D8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824914D8 size=8
    let mut pc: u32 = 0x824914D8;
    'dispatch: loop {
        match pc {
            0x824914D8 => {
    //   block [0x824914D8..0x824914E0)
...
pub fn sub_824914E0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824914E0 size=24
    let mut pc: u32 = 0x824914E0;
    'dispatch: loop {
        match pc {
            0x824914E0 => {
    //   block [0x824914E0..0x824914F8)
...
pub fn sub_82491508(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491508 size=8
    let mut pc: u32 = 0x82491508;
    'dispatch: loop {
        match pc {
            0x82491508 => {
    //   block [0x82491508..0x82491510)
...
pub fn sub_82491510(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491510 size=24
    let mut pc: u32 = 0x82491510;
    'dispatch: loop {
        match pc {
            0x82491510 => {
    //   block [0x82491510..0x82491528)
...
pub fn sub_82491550(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491550 size=8
    let mut pc: u32 = 0x82491550;
    'dispatch: loop {
        match pc {
            0x82491550 => {
    //   block [0x82491550..0x82491558)
...
pub fn sub_82491558(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491558 size=24
    let mut pc: u32 = 0x82491558;
    'dispatch: loop {
        match pc {
            0x82491558 => {
    //   block [0x82491558..0x82491570)
...
pub fn sub_82491598(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491598 size=12
    let mut pc: u32 = 0x82491598;
    'dispatch: loop {
        match pc {
            0x82491598 => {
    //   block [0x82491598..0x824915A4)
...
pub fn sub_824915A4(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824915A4 size=8
    let mut pc: u32 = 0x824915A4;
    'dispatch: loop {
        match pc {
            0x824915A4 => {
    //   block [0x824915A4..0x824915AC)
...
pub fn sub_82491740(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491740 size=12
    let mut pc: u32 = 0x82491740;
    'dispatch: loop {
        match pc {
            0x82491740 => {
    //   block [0x82491740..0x8249174C)
...
pub fn sub_8249174C(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x8249174C size=8
    let mut pc: u32 = 0x8249174C;
    'dispatch: loop {
        match pc {
            0x8249174C => {
    //   block [0x8249174C..0x82491754)
...
pub fn sub_824917B8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824917B8 size=8
    let mut pc: u32 = 0x824917B8;
    'dispatch: loop {
        match pc {
            0x824917B8 => {
    //   block [0x824917B8..0x824917C0)
...
pub fn sub_824917C0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824917C0 size=24
    let mut pc: u32 = 0x824917C0;
    'dispatch: loop {
        match pc {
            0x824917C0 => {
    //   block [0x824917C0..0x824917D8)
...
pub fn sub_824917E8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824917E8 size=12
    let mut pc: u32 = 0x824917E8;
    'dispatch: loop {
        match pc {
            0x824917E8 => {
    //   block [0x824917E8..0x824917F4)
...
pub fn sub_824917F4(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824917F4 size=8
    let mut pc: u32 = 0x824917F4;
    'dispatch: loop {
        match pc {
            0x824917F4 => {
    //   block [0x824917F4..0x824917FC)
...
pub fn sub_82491870(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491870 size=8
    let mut pc: u32 = 0x82491870;
    'dispatch: loop {
        match pc {
            0x82491870 => {
    //   block [0x82491870..0x82491878)
...
pub fn sub_82491878(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491878 size=24
    let mut pc: u32 = 0x82491878;
    'dispatch: loop {
        match pc {
            0x82491878 => {
    //   block [0x82491878..0x82491890)
...
pub fn sub_824918A8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824918A8 size=12
    let mut pc: u32 = 0x824918A8;
    'dispatch: loop {
        match pc {
            0x824918A8 => {
    //   block [0x824918A8..0x824918B4)
...
pub fn sub_824918B4(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x824918B4 size=8
    let mut pc: u32 = 0x824918B4;
    'dispatch: loop {
        match pc {
            0x824918B4 => {
    //   block [0x824918B4..0x824918BC)
...
pub fn sub_82491910(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491910 size=20
    let mut pc: u32 = 0x82491910;
    'dispatch: loop {
        match pc {
            0x82491910 => {
    //   block [0x82491910..0x82491924)
	// 82491910: 81630000  lwz r11, 0(r3)
	ctx.r[11].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[3].u32.wrapping_add(0 as u32) ) } as u64;
	// 82491914: 38800000  li r4, 0
	ctx.r[4].s64 = 0;
	// 82491918: 816B0000  lwz r11, 0(r11)
	ctx.r[11].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[11].u32.wrapping_add(0 as u32) ) } as u64;
	// 8249191C: 7D6903A6  mtctr r11
	ctx.ctr.u64 = ctx.r[11].u64;
	// 82491920: 4E800420  bctr
	crate::rt::call_indirect(ctx.ctr.u32);
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
...
pub fn sub_82491928(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491928 size=12
    let mut pc: u32 = 0x82491928;
    'dispatch: loop {
        match pc {
            0x82491928 => {
    //   block [0x82491928..0x82491934)
	// 82491928: 38800001  li r4, 1
	ctx.r[4].s64 = 1;
	// 8249192C: 2B030000  cmplwi cr6, r3, 0
	ctx.cr[6].compare_u32(ctx.r[3].u32, 0 as u32, &mut ctx.xer);
	// 82491930: 4D9A0020  beqlr cr6
	if ctx.cr[6].eq { return; }
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_82491934(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491934 size=8
    let mut pc: u32 = 0x82491934;
    'dispatch: loop {
        match pc {
            0x82491934 => {
    //   block [0x82491934..0x8249193C)
	// 82491934: 4800003C  b 0x82491970
	sub_82491970(ctx, base);
	return;
	// 82491938: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_82491A58(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491A58 size=8
    let mut pc: u32 = 0x82491A58;
    'dispatch: loop {
        match pc {
            0x82491A58 => {
    //   block [0x82491A58..0x82491A60)
...
pub fn sub_82491A60(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491A60 size=24
    let mut pc: u32 = 0x82491A60;
    'dispatch: loop {
        match pc {
            0x82491A60 => {
    //   block [0x82491A60..0x82491A78)
...
pub fn sub_82491AA0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491AA0 size=8
    let mut pc: u32 = 0x82491AA0;
    'dispatch: loop {
        match pc {
            0x82491AA0 => {
    //   block [0x82491AA0..0x82491AA8)
...
pub fn sub_82491AA8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491AA8 size=24
    let mut pc: u32 = 0x82491AA8;
    'dispatch: loop {
        match pc {
            0x82491AA8 => {
    //   block [0x82491AA8..0x82491AC0)
...
pub fn sub_82491AD8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491AD8 size=12
    let mut pc: u32 = 0x82491AD8;
    'dispatch: loop {
        match pc {
            0x82491AD8 => {
    //   block [0x82491AD8..0x82491AE4)
...
pub fn sub_82491AE4(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491AE4 size=8
    let mut pc: u32 = 0x82491AE4;
    'dispatch: loop {
        match pc {
            0x82491AE4 => {
    //   block [0x82491AE4..0x82491AEC)
...
pub fn sub_82491B40(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491B40 size=12
    let mut pc: u32 = 0x82491B40;
    'dispatch: loop {
        match pc {
            0x82491B40 => {
    //   block [0x82491B40..0x82491B4C)
	// 82491B40: 38800001  li r4, 1
	ctx.r[4].s64 = 1;
	// 82491B44: 2B030000  cmplwi cr6, r3, 0
	ctx.cr[6].compare_u32(ctx.r[3].u32, 0 as u32, &mut ctx.xer);
	// 82491B48: 4D9A0020  beqlr cr6
	if ctx.cr[6].eq { return; }
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_82491B4C(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491B4C size=8
    let mut pc: u32 = 0x82491B4C;
    'dispatch: loop {
        match pc {
            0x82491B4C => {
    //   block [0x82491B4C..0x82491B54)
	// 82491B4C: 4801B6BC  b 0x824ad208
	sub_824AD208(ctx, base);
	return;
	// 82491B50: 4E800020  blr
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
        }
...
pub fn sub_82491B58(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491B58 size=20
    let mut pc: u32 = 0x82491B58;
    'dispatch: loop {
        match pc {
            0x82491B58 => {
    //   block [0x82491B58..0x82491B6C)
	// 82491B58: 81630000  lwz r11, 0(r3)
	ctx.r[11].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[3].u32.wrapping_add(0 as u32) ) } as u64;
	// 82491B5C: 38800000  li r4, 0
	ctx.r[4].s64 = 0;
	// 82491B60: 816B0000  lwz r11, 0(r11)
	ctx.r[11].u64 = unsafe { crate::rt::load_u32( base as *const u8, ctx.r[11].u32.wrapping_add(0 as u32) ) } as u64;
	// 82491B64: 7D6903A6  mtctr r11
	ctx.ctr.u64 = ctx.r[11].u64;
	// 82491B68: 4E800420  bctr
	crate::rt::call_indirect(ctx.ctr.u32);
	return;
            }
            _ => unsafe { core::hint::unreachable_unchecked() },
...
pub fn sub_82491BB8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491BB8 size=8
    let mut pc: u32 = 0x82491BB8;
    'dispatch: loop {
        match pc {
            0x82491BB8 => {
    //   block [0x82491BB8..0x82491BC0)
...
pub fn sub_82491BC0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491BC0 size=24
    let mut pc: u32 = 0x82491BC0;
    'dispatch: loop {
        match pc {
            0x82491BC0 => {
    //   block [0x82491BC0..0x82491BD8)
...
pub fn sub_82491C68(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491C68 size=8
    let mut pc: u32 = 0x82491C68;
    'dispatch: loop {
        match pc {
            0x82491C68 => {
    //   block [0x82491C68..0x82491C70)
...
pub fn sub_82491C70(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491C70 size=24
    let mut pc: u32 = 0x82491C70;
    'dispatch: loop {
        match pc {
            0x82491C70 => {
    //   block [0x82491C70..0x82491C88)
...
pub fn sub_82491CB0(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491CB0 size=8
    let mut pc: u32 = 0x82491CB0;
    'dispatch: loop {
        match pc {
            0x82491CB0 => {
    //   block [0x82491CB0..0x82491CB8)
...
pub fn sub_82491CB8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491CB8 size=24
    let mut pc: u32 = 0x82491CB8;
    'dispatch: loop {
        match pc {
            0x82491CB8 => {
    //   block [0x82491CB8..0x82491CD0)
...
pub fn sub_82491CF8(ctx: &mut crate::recompiler::ppc_context::PPCContext, base: *mut u8) {
    // ---- function 0x82491CF8 size=12
    let mut pc: u32 = 0x82491CF8;
    'dispatch: loop {
        match pc {
            0x82491CF8 => {
    //   block [0x82491CF8..0x82491D04)
